<?php
/*
Plugin Name: WordPress Social Login ( Fork )
Plugin URI: https://github.com/fursserg/wordpress-social-login
Description: Allow your visitors to comment and login with social networks such as Twitter, Facebook, Google, Yahoo and more. In fork version, the session_start () call was cut on each page of the site. This is necessary for the server to work properly on the server cache.  
Version: 2.4.0
...
$WORDPRESS_SOCIAL_LOGIN_VERSION = "2.4.0";
...
function wsl_add_plugin_row_meta( $links, $file )
{
	...
	{
		$wsl_links = array(
			'<a href="http://miled.github.io/wordpress-social-login/">'             . _wsl__( "Docs original version"             , 'wordpress-social-login' ) . '</a>',
		);
